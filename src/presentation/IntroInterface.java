    ...
    private void prepareActionsNormalSelectorPanel() {
        ...
        aiVsAILabel.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                Machine ai1 = (Machine) mainGUI.getGame().getTrainers().get(0);
                mainGUI.getGame().createTrainerMachine("expert");
                Machine ai2 = (Machine) mainGUI.getGame().getTrainers().get(1);
                mainGUI.setPanelBattlefield(new Battlefield(width,heigth, (byte)0));
